...
//  ExGhostty_iPad
//
//  Codable models for the JSON lines emitted by `xtop --all --json --stream`.
//  Ported from the Mac version's SystemMonitorModels.swift — keep the field
//  names (xtop's wire format, mixed case on purpose) in sync with that file.
//
